...
class InvoiceUpload(models.Model):
    ...
    def cloudinary_url(self):
        return self.file.url  # Django Cloudinary tự tạo link public
...
class CompanyVerification(models.Model):
    ...
    source = models.CharField(max_length=50, default="masothue")  # masothue / manual
    status = models.CharField(max_length=10, choices=[("PASS", "PASS"), ("FAIL", "FAIL")])
    message = models.TextField(blank=True)  # "Tên trùng khớp", "Sai địa chỉ"
