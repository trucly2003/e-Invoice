...
class InvoiceData(models.Model):
    ...
    invoice_code = models.CharField(max_length=50, null=True, blank=True)  # Cập nhật
    ...
    total_amount = models.DecimalField(max_digits=15, decimal_places=2, null=True, blank=True)  # Cập nhật
    status = models.CharField(max_length=50, null=True, blank=True)  # Cập nhật
    ref_no = models.CharField(max_length=50, null=True, blank=True)  # Cập nhật
    bl_number = models.CharField(max_length=50, null=True, blank=True)  # Cập nhật
    bank_account_vnd = models.CharField(max_length=100, null=True, blank=True)  # Cập nhật
    bank_account_usd = models.CharField(max_length=100, null=True, blank=True)  # Cập nhật
